...
a persistence unit "maven-kursPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "maven-kurs\pom.xml":
...
artifacts ("maven-kurs-ejb.jar" and "maven-kurs-web.war") are already built. You can build
